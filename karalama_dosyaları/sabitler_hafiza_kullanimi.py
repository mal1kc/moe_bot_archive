...
try:
    ...
    def current_memory_usage() -> int:
        ...
        # return win32process.GetProcessMemoryInfo(process)["WorkingSetSize"] // 1024  # as kilobytes
        return win32process.GetProcessMemoryInfo(process)["WorkingSetSize"] // 1024 // 1024  # as megabytes
...
def main():
    ...
    print("mem usage after imports: ", current_memory_usage())
    ...
    print("mem usage after class definition: ", current_memory_usage())
