...
def to_dict() -> dict[str, dict[str, str] | str]:
    return {
        "UI": {
            ...
            # -- Error messages
            "login_error_username_too_short_or_long": "Username must be between 3 and 45 characters.",
            "login_error_password_too_short_or_long": "Password must be between 3 and 45 characters.",
            "login_error_connection_error": "Could not connect to server.",
            "login_error_package_not_found": "Package not found.",
            "login_error_maximum_login_error": "Maximum login quota reached. Try again in 25 minutes.",
